const h8s2600_disassembler::disasm_entry h8s2600_disassembler::disasm_entries[] = {
	...
	{ 1, 0x01106d71, 0xfffffff9, 0x0000, 0x0000, "ldm.l", DASM_spp, DASM_r32n2l, 4 }, // inherited
	{ 1, 0x01106df0, 0xfffffff9, 0x0000, 0x0000, "stm.l", DASM_r32n2l, DASM_psp, 4 }, // inherited
	{ 1, 0x01206d72, 0xfffffffb, 0x0000, 0x0000, "ldm.l", DASM_spp, DASM_r32n3l, 4 }, // inherited
	{ 1, 0x01206df0, 0xfffffffb, 0x0000, 0x0000, "stm.l", DASM_r32n3l, DASM_psp, 4 }, // inherited
	{ 1, 0x01306d73, 0xfffffffb, 0x0000, 0x0000, "ldm.l", DASM_spp, DASM_r32n4l, 4 }, // inherited
	{ 1, 0x01306df0, 0xfffffffb, 0x0000, 0x0000, "stm.l", DASM_r32n4l, DASM_psp, 4 }, // inherited
	...
	{ 1, 0x01410400, 0xffffff00, 0x0000, 0x0000, "orc", DASM_imm8, DASM_exr, 4 }, // inherited
	{ 1, 0x01410500, 0xffffff00, 0x0000, 0x0000, "xorc", DASM_imm8, DASM_exr, 4 }, // inherited
	{ 1, 0x01410600, 0xffffff00, 0x0000, 0x0000, "andc", DASM_imm8, DASM_exr, 4 }, // inherited
	{ 1, 0x01410700, 0xffffff00, 0x0000, 0x0000, "ldc", DASM_imm8, DASM_exr, 4 }, // inherited
	{ 1, 0x01416900, 0xffffff8f, 0x0000, 0x0000, "ldc.w", DASM_r32ih, DASM_exr, 4 }, // inherited
	{ 1, 0x01416980, 0xffffff8f, 0x0000, 0x0000, "stc.w", DASM_exr, DASM_r32ih, 4 }, // inherited
	{ 1, 0x01416b00, 0xffffffff, 0x0000, 0x0000, "ldc.w", DASM_abs16, DASM_exr, 6 }, // inherited
	{ 1, 0x01416b20, 0xffffffff, 0x0000, 0x0000, "ldc.w", DASM_abs32, DASM_exr, 8 }, // inherited
	{ 1, 0x01416b80, 0xffffffff, 0x0000, 0x0000, "stc.w", DASM_exr, DASM_abs16, 6 }, // inherited
	{ 1, 0x01416ba0, 0xffffffff, 0x0000, 0x0000, "stc.w", DASM_exr, DASM_abs32, 8 }, // inherited
	{ 1, 0x01416d00, 0xffffff8f, 0x0000, 0x0000, "ldc.w", DASM_r32ph, DASM_exr, 4 }, // inherited
	{ 1, 0x01416d80, 0xffffff8f, 0x0000, 0x0000, "stc.w", DASM_exr, DASM_pr32h, 4 }, // inherited
	{ 1, 0x01416f00, 0xffffff8f, 0x0000, 0x0000, "ldc.w", DASM_r32d16h, DASM_exr, 6 }, // inherited
	{ 1, 0x01416f80, 0xffffff8f, 0x0000, 0x0000, "stc.w", DASM_exr, DASM_r32d16h, 6 }, // inherited
	{ 4, 0x78006b20, 0xff8fffff, 0x0141, 0xffff, "ldc.w", DASM_r32d32hh, DASM_exr, 10 }, // inherited
	{ 4, 0x78806ba0, 0xff8fffff, 0x0141, 0xffff, "stc.w", DASM_exr, DASM_r32d32hh, 10 }, // inherited
	{ 1, 0x01606d00, 0xffffff88, 0x0000, 0x0000, "mac", DASM_r32ph, DASM_r32pl, 4 }, // needed
	{ 0, 0x00000180, 0x0000ffff, 0x0000, 0x0000, "sleep", DASM_none, DASM_none, 2 }, // inherited
	{ 0, 0x000001a0, 0x0000ffff, 0x0000, 0x0000, "clrmac", DASM_none, DASM_none, 2 }, // needed
	...
	{ 1, 0x01e07b0c, 0xffffffaf, 0x0000, 0x0000, "tas", DASM_r32ih, DASM_none, 4 }, // inherited
	...
	{ 0, 0x00000210, 0x0000fff0, 0x0000, 0x0000, "stc", DASM_exr, DASM_r8l, 2 }, // inherited
	{ 0, 0x00000220, 0x0000fff8, 0x0000, 0x0000, "stmac", DASM_mach, DASM_r32l, 2 }, // needed
	{ 0, 0x00000230, 0x0000fff8, 0x0000, 0x0000, "stmac", DASM_macl, DASM_r32l, 2 }, // needed
	{ 0, 0x00000300, 0x0000fff0, 0x0000, 0x0000, "ldc", DASM_r8l, DASM_ccr, 2 }, // inherited
	{ 0, 0x00000310, 0x0000fff0, 0x0000, 0x0000, "ldc", DASM_r8l, DASM_exr, 2 }, // inherited
	{ 0, 0x00000320, 0x0000fff8, 0x0000, 0x0000, "ldmac", DASM_r32l, DASM_mach, 2 }, // needed
	{ 0, 0x00000330, 0x0000fff8, 0x0000, 0x0000, "ldmac", DASM_r32l, DASM_macl, 2 }, // needed
	...
	{ 0, 0x00001040, 0x0000fff0, 0x0000, 0x0000, "shll.b", DASM_two, DASM_r8l, 2 }, // inherited
	{ 0, 0x00001050, 0x0000fff0, 0x0000, 0x0000, "shll.w", DASM_two, DASM_r16l, 2 }, // inherited
	{ 0, 0x00001070, 0x0000fff8, 0x0000, 0x0000, "shll.l", DASM_two, DASM_r32l, 2 }, // inherited
	...
	{ 0, 0x000010c0, 0x0000fff0, 0x0000, 0x0000, "shal.b", DASM_two, DASM_r8l, 2 }, // inherited
	{ 0, 0x000010d0, 0x0000fff0, 0x0000, 0x0000, "shal.w", DASM_two, DASM_r16l, 2 }, // inherited
	{ 0, 0x000010f0, 0x0000fff8, 0x0000, 0x0000, "shal.l", DASM_two, DASM_r32l, 2 }, // inherited
	...
	{ 0, 0x00001140, 0x0000fff0, 0x0000, 0x0000, "shlr.b", DASM_two, DASM_r8l, 2 }, // inherited
	{ 0, 0x00001150, 0x0000fff0, 0x0000, 0x0000, "shlr.w", DASM_two, DASM_r16l, 2 }, // inherited
	{ 0, 0x00001170, 0x0000fff8, 0x0000, 0x0000, "shlr.l", DASM_two, DASM_r32l, 2 }, // inherited
	...
	{ 0, 0x000011c0, 0x0000fff0, 0x0000, 0x0000, "shar.b", DASM_two, DASM_r8l, 2 }, // inherited
	{ 0, 0x000011d0, 0x0000fff0, 0x0000, 0x0000, "shar.w", DASM_two, DASM_r16l, 2 }, // inherited
	{ 0, 0x000011f0, 0x0000fff8, 0x0000, 0x0000, "shar.l", DASM_two, DASM_r32l, 2 }, // inherited
	...
	{ 0, 0x00001240, 0x0000fff0, 0x0000, 0x0000, "rotxl.b", DASM_two, DASM_r8l, 2 }, // inherited
	{ 0, 0x00001250, 0x0000fff0, 0x0000, 0x0000, "rotxl.w", DASM_two, DASM_r16l, 2 }, // inherited
	{ 0, 0x00001270, 0x0000fff8, 0x0000, 0x0000, "rotxl.l", DASM_two, DASM_r32l, 2 }, // inherited
	...
	{ 0, 0x000012c0, 0x0000fff0, 0x0000, 0x0000, "rotl.b", DASM_two, DASM_r8l, 2 }, // inherited
	{ 0, 0x000012d0, 0x0000fff0, 0x0000, 0x0000, "rotl.w", DASM_two, DASM_r16l, 2 }, // inherited
	{ 0, 0x000012f0, 0x0000fff8, 0x0000, 0x0000, "rotl.l", DASM_two, DASM_r32l, 2 }, // inherited
	...
	{ 0, 0x00001340, 0x0000fff0, 0x0000, 0x0000, "rotxr.b", DASM_two, DASM_r8l, 2 }, // inherited
	{ 0, 0x00001350, 0x0000fff0, 0x0000, 0x0000, "rotxr.w", DASM_two, DASM_r16l, 2 }, // inherited
	{ 0, 0x00001370, 0x0000fff8, 0x0000, 0x0000, "rotxr.l", DASM_two, DASM_r32l, 2 }, // inherited
	...
	{ 0, 0x000013c0, 0x0000fff0, 0x0000, 0x0000, "rotr.b", DASM_two, DASM_r8l, 2 }, // inherited
	{ 0, 0x000013d0, 0x0000fff0, 0x0000, 0x0000, "rotr.w", DASM_two, DASM_r16l, 2 }, // inherited
	{ 0, 0x000013f0, 0x0000fff8, 0x0000, 0x0000, "rotr.l", DASM_two, DASM_r32l, 2 }, // inherited
