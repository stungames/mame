	...
	case 253:	goto state_253;
	case 254:	goto state_254;
	case 255:	goto state_255;
	case 256:	goto state_256;
	case 257:	goto state_257;
	case 258:	goto state_258;
	case 259:	goto state_259;
	case 260:	goto state_260;
	case 261:	goto state_261;
	case 262:	goto state_262;
	case 263:	goto state_263;
	case 264:	goto state_264;
	case 265:	goto state_265;
	case 266:	goto state_266;
	case 267:	goto state_267;
	case 268:	goto state_268;
	case 269:	goto state_269;
	case 270:	goto state_270;
	case 271:	goto state_271;
	case 272:	goto state_272;
	case 273:	goto state_273;
	case 274:	goto state_274;
	case 275:	goto state_275;
	case 276:	goto state_276;
	case 277:	goto state_277;
	case 278:	goto state_278;
	case 279:	goto state_279;
	case 280:	goto state_280;
	case 281:	goto state_281;
	case 282:	goto state_282;
	case 283:	goto state_283;
	case 284:	goto state_284;
	case 285:	goto state_285;
	case 286:	goto state_286;
	case 287:	goto state_287;
	case 288:	goto state_288;
	case 289:	goto state_289;
	case 290:	goto state_290;
	case 291:	goto state_291;
	case 292:	goto state_292;
	case 293:	goto state_293;
	case 294:	goto state_294;
	case 295:	goto state_295;
	default:
...
state_166:
	set_regop16(m_s);
	m_cc = read_memory(regop16().w++); 	if (UNEXPECTED(m_icount <= 0)) { push_state(167); return; }
state_167:
// PULS CC
...
EXG:
	{
		...
		uint16_t reg1 = read_exgtfr_register(param >> 4);
		uint16_t reg2 = read_exgtfr_register(param >> 0);
...
TFR:
	{
		uint8_t param = read_opcode_arg();
		uint16_t reg = read_exgtfr_register(param >> 4);
...
state_243:
	...
	eat(1); 	if (UNEXPECTED(m_icount <= 0)) { push_state(244); return; }
state_244:
...
state_245:
	m_cc &= ~CC_V;
	m_temp.b.l = set_flags(CC_NZ, (uint8_t)0, m_temp.b.l, m_temp.b.l & m_temp_im);
	eat(1); 	if (UNEXPECTED(m_icount <= 0)) { push_state(246); return; }
state_246:
// this is just a guess
	write_operand(m_temp.b.l);
	return;
...
state_247:
	m_cc &= ~CC_V;
	m_temp.b.l = set_flags(CC_NZ, (uint8_t)0, m_temp.b.l, m_temp.b.l ^ m_temp_im);
	eat(1); 	if (UNEXPECTED(m_icount <= 0)) { push_state(248); return; }
state_248:
// this is just a guess
	write_operand(m_temp.b.l);
	return;
...
state_249:
	m_cc &= ~CC_V;
	m_temp.b.l = set_flags(CC_NZ, (uint8_t)0, m_temp.b.l, m_temp.b.l & m_temp_im);
	eat(2); 	if (UNEXPECTED(m_icount <= 0)) { push_state(250); return; }
state_250:
// this is just a guess
	return;
...
state_252:
		...
		if (!tfr_write(m_opcode, m_temp.b.l, m_temp.b.h))
			goto ILLEGAL;
		eat(1);
		if (UNEXPECTED(m_icount <= 0)) { push_state(253); return; }
state_253:
...
ADC16:
	m_temp.b.h = read_operand(0);
	if (UNEXPECTED(m_icount <= 0)) { push_state(254); return; }
state_254:
	m_temp.b.l = read_operand(1);
	if (UNEXPECTED(m_icount <= 0)) { push_state(255); return; }
state_255:
...
SBC16:
	m_temp.b.h = read_operand(0);
	if (UNEXPECTED(m_icount <= 0)) { push_state(256); return; }
state_256:
	m_temp.b.l = read_operand(1);
	if (UNEXPECTED(m_icount <= 0)) { push_state(257); return; }
state_257:
	regop16().w = set_flags(CC_NZVC, regop16().w, m_temp.w, regop16().w - m_temp.w - (m_cc & CC_C ? 1 : 0));
	eat(hd6309_native_mode() ? 0 : 1);
	return;
...
AND16:
	m_temp.b.h = read_operand(0);
	if (UNEXPECTED(m_icount <= 0)) { push_state(258); return; }
state_258:
	m_temp.b.l = read_operand(1);
	if (UNEXPECTED(m_icount <= 0)) { push_state(259); return; }
state_259:
	m_cc &= ~CC_V;
...
BIT16:
	m_temp.b.h = read_operand(0);
	if (UNEXPECTED(m_icount <= 0)) { push_state(260); return; }
state_260:
	m_temp.b.l = read_operand(1);
	if (UNEXPECTED(m_icount <= 0)) { push_state(261); return; }
state_261:
	m_cc &= ~CC_V;
...
OR16:
	m_temp.b.h = read_operand(0);
	if (UNEXPECTED(m_icount <= 0)) { push_state(262); return; }
state_262:
	m_temp.b.l = read_operand(1);
	if (UNEXPECTED(m_icount <= 0)) { push_state(263); return; }
state_263:
	m_cc &= ~CC_V;
	regop16().w = set_flags(CC_NZ, (uint16_t)0, regop16().w, regop16().w | m_temp.w);
	return;
...
EOR16:
	m_temp.b.h = read_operand(0);
	if (UNEXPECTED(m_icount <= 0)) { push_state(264); return; }
state_264:
	m_temp.b.l = read_operand(1);
	if (UNEXPECTED(m_icount <= 0)) { push_state(265); return; }
state_265:
	m_cc &= ~CC_V;
	regop16().w = set_flags(CC_NZ, (uint16_t)0, regop16().w, regop16().w ^ m_temp.w);
	return;
...
state_267:
	m_temp.b.l = read_operand();
	if (UNEXPECTED(m_icount <= 0)) { push_state(268); return; }
state_268:
...
state_270:
	m_temp.b.l = read_operand();
	if (UNEXPECTED(m_icount <= 0)) { push_state(271); return; }
state_271:
	bittest_set(bittest_dest() && !bittest_source());
	return;
...
state_273:
	m_temp.b.l = read_operand();
	if (UNEXPECTED(m_icount <= 0)) { push_state(274); return; }
state_274:
	bittest_set(bittest_dest() || bittest_source());
	return;
...
state_276:
	m_temp.b.l = read_operand();
	if (UNEXPECTED(m_icount <= 0)) { push_state(277); return; }
state_277:
	bittest_set(bittest_dest() || !bittest_source());
	return;
...
state_279:
	m_temp.b.l = read_operand();
	if (UNEXPECTED(m_icount <= 0)) { push_state(280); return; }
state_280:
	bittest_set(bittest_dest() != bittest_source());
	return;
...
state_282:
	m_temp.b.l = read_operand();
	if (UNEXPECTED(m_icount <= 0)) { push_state(283); return; }
state_283:
	bittest_set(bittest_dest() != !bittest_source());
	return;
...
state_285:
	m_temp.b.l = read_operand();
	if (UNEXPECTED(m_icount <= 0)) { push_state(286); return; }
state_286:
...
state_288:
	m_temp.b.l = read_operand();
	if (UNEXPECTED(m_icount <= 0)) { push_state(289); return; }
state_289:
	if (bittest_source())
		...
		m_temp.b.l &= ~(1 << ((m_temp_im >> 0) & 0x07));
	eat(2);
	if (UNEXPECTED(m_icount <= 0)) { push_state(290); return; }
state_290:
	write_operand(m_temp.b.l);
	return;
...
MULD:
	m_temp.b.h = read_operand(0);
	if (UNEXPECTED(m_icount <= 0)) { push_state(291); return; }
state_291:
	m_temp.b.l = read_operand(1);
	if (UNEXPECTED(m_icount <= 0)) { push_state(292); return; }
state_292:
	muld();
	return;
...
DIVQ:
	m_temp.b.h = read_operand(0);
	if (UNEXPECTED(m_icount <= 0)) { push_state(293); return; }
state_293:
	m_temp.b.l = read_operand(1);
	if (UNEXPECTED(m_icount <= 0)) { push_state(294); return; }
state_294:
	if (!divq())
		goto DIVIDE_BY_ZERO;
	return;
...
DIVD:
	m_temp.b.l = read_operand();
	if (UNEXPECTED(m_icount <= 0)) { push_state(295); return; }
state_295:
	if (!divd())
		goto DIVIDE_BY_ZERO;
	return;
